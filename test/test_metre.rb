# Add to Sonic Pi's test suite to run
...
module SonicPi
  ...
  class MetreTester < Minitest::Test
    ...
    def test_flat
      four_four = Metre::Metre.new([[1/8r, 1/8r], [1/8r, 1/8r], [1/8r, 1/8r], [1/8r, 1/8r]])
      ten_eight = Metre::Metre.new([[1/8r, 1/8r, 1/8r], [1/8r, 1/8r, 1/8r], [1/8r, 1/8r], [1/8r, 1/8r]])
      eleven_eight = Metre::Metre.new([[1/8r, 1/8r], [1/8r, 1/8r], 1/8r, 3/4r])
